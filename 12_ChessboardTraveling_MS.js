...
function ChessboardTraveling(str){
    ...
    // to check the correct format of the paramaeter passed
    regEx = /^(dsd)(dsd)$/
    var isFormatted = regEx.test(str);

    // if the format in correct perform computation
    if (isFormatted) {
        ...
        // formula to calculate the total number of combination the destination can be achieved
        // Detailed explaination at the bottom
...
// function to calculate factorial using recursion function
